...
- Readings gate in `EXTRACTION.md` (trigger f): enumerate live readings, pin the domain first, user confirms; culture-flag rule — slang/dialect/jargon gets asked about, never silently normalized (AAE→SAE silent correction arXiv:2607.06845; dialect underuse/misuse arXiv:2602.21485); grounding criterion = both sides state the agreed reading back (Clark & Brennan). Flagged-terms table in `INBOX.md` ledger persists picks + discarded readings.
