...
|---|---|---|---|---|---|---|---|
| **Ithmb-Codec** | `docs/FEATURES.md` (F-001..F-024) | `../steps/SPECIFICATION.md` (FR-01..50, NFR-01..08) | `ARCHITECTURE.md` | `docs/TECH_DEBT_AUDIT.md` | `docs/adr/` (8 ADRs) | `scripts/local-ci.sh` (7 gates) | `.github/workflows/ci-full` + `pr-checks` (matrix) |
