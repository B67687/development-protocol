...
| 2.11 | **[MANDATORY]** AI agents keep existing formatting, style, and organization intact when making changes | T1 | Side-effect changes introduce review noise and obscure the change. | Karpathy Guidelines Step 3; Agent Skills |
| 2.12 | **[MANDATORY]** AI agents refactor only the code they were asked to modify | T1 | Unsolicited refactoring breaks the principle of least surprise. | Karpathy Guidelines Step 3; Agent Skills |
